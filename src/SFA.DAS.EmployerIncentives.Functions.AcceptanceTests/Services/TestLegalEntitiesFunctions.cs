...
namespace SFA.DAS.EmployerIncentives.Functions.AcceptanceTests.Services
{
    public class TestLegalEntitiesFunctions : IDisposable
    {
        ...
        public HandleActivateCollectionCalendarPeriod HttpTriggerActivateCollectionCalendarPeriod { get; set; }
        ...
        public async Task Start()
        {
            ...
            HttpTriggerActivateCollectionCalendarPeriod = new HandleActivateCollectionCalendarPeriod(host.Services.GetService(typeof(ICollectionCalendarService)) as ICollectionCalendarService);
